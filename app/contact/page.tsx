              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">contact@herahima.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">+33 1 42 60 00 00</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">24 Place Vendôme, 75001 Paris</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Lun - Sam : 10h - 19h</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              {sent ? (
                <div className="bg-secondary/20 p-8 text-center rounded">
                  ...
                  <button onClick={() => setSent(false)} className="mt-4 text-sm underline">Envoyer un autre message</button>
                </div>
              ) : (
