...
export default function FemmesPage() {
  ...
  useEffect(() => {
    fetch(`/api/products?category=women&lang=${lang}`).then(r => r.ok ? r.json() : []).then(setProducts).catch(() => setProducts([]))
  }, [lang])
    ...
    <div className="min-h-screen pt-28 pb-24">
      <div className="max-w-[1800px] mx-auto px-6 md:px-12">
        <div className="text-center mb-16">
          ...
          <h1 className="font-serif text-5xl md:text-7xl tracking-tight mb-6">{t.header.women}</h1>
